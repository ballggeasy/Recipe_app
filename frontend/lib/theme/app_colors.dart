...
/// โทนสีของดีไซน์ซิสเต็ม — อบอุ่น มินิมอล พรีเมียม โทนดินเผา (terracotta) คู่เขียวปัดฟ้า (teal)
class AppColors {
  AppColors._();
  ...
  // ---- โหมดมืด ----
  static const backgroundDark = Color(0xFF17140F);
  static const surfaceDark = Color(0xFF211C16);
  static const surfaceMutedDark = Color(0xFF2B241C);
  static const primaryDark = Color(0xFFE08A5D);
  static const primaryMutedDark = Color(0xFF3A281D);
  static const secondaryDark = Color(0xFF5FA8A0);
  static const secondaryMutedDark = Color(0xFF1E3533);
  static const textPrimaryDark = Color(0xFFF2EAE1);
  static const textSecondaryDark = Color(0xFFA99C8E);
  static const dividerDark = Color(0xFF362E24);
  static const successDark = Color(0xFF6FBF95);
